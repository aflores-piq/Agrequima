...
/* ---------------------------------------------------------------------
   AGRUPADOR DE CUENTAS CONTABLES (Financiero -- Estados Financieros)
   Fuente de la columna "Grupo" en las 4 paginas de Estados Financieros.
   Emparejamiento jerarquico por codigo de cuenta: Nivel 3 (codigo
   completo exacto) -> Nivel 2 (primeros 6 digitos) -> Nivel 1 (primeros
   4 digitos). Ver backend/app/services/agrupador_cuentas.py.
   --------------------------------------------------------------------- */
